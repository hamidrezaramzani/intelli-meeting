  ...
  return (
    <div className="rounded-md">
      ...
      <div className={`relative ${widthClass}`}>
        <select
          className={`bg-white border font-regular rounded-xl text-gray-900 text-sm font-roboto  block w-full p-2.5 pr-8 outline-none appearance-none transition-colors
